...
function Invoke-ClassTimer {
  ...
  .DESCRIPTION
    ...
    and one other timezone of your choice,Perth by default. Determining when each city 
    should end the event they are undertaking break/lab, relevant to their timezone.
    You can enter the "Event Length" time and then click 
    "Calculate End Time" or you can just click the "Calculate Return Time"
    and it will automatically fill 15 minutes into the Event Length.
    It will then display the return times for the 4 cities and also 
    start a countdown timer in red.
  .EXAMPLE
    Invoke-ClassTimer
  ...
  $HowlongLbl.text             = "Event Length (min.)"
  ...
  $CalcEndBtn.text             = "Calculate End Time"
